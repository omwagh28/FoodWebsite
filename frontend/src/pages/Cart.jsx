...
const stripePromise = loadStripe('pk_test_51QivT7KXEcIbufp7SjMmCWvko0Ql6M1PqrTKp1YlQdmiLHohNrA0BW602SQ88w5soURVCsg8Bj0FRscu1l4JFpp900V05wzKdo');
...
const Cart = () => {
    ...
    const handleCheckout = async () => {
        ...
        try {
            const response = await axios.post(`${process.env.}/stripe/create-checkout-session`, {
